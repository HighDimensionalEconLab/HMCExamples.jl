...
joint_1 = pd.read_csv(".experiments/rbc_student_t/rbc_student_t_1_joint/sumstats.csv").drop(columns = "Parameter").drop(columns = "Num_error")
...
num = 9
with open(".tables/sumstats_rbc_student_t_1_joint.tex", "w") as f:
    f.write(r"""\begin{table}[h]
\caption{NUTS with Joint Likelihood, RBC Model with Student's T Shocks, First-order}
\label{tab:rbc_student_t_NUTS_joint_1}
\centering
\scriptsize
""")
