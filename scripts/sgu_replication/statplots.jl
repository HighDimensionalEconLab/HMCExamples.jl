...
function generate_plots(batch, shocks, include_vars)
...
generate_plots("1_joint", "data/sgu_1_fixed_high_shocks.csv", ["α", "γ", "ψ", "β_draw", "ρ", "ρ_u", "ρ_v"])
generate_plots("2_joint", "data/sgu_2_fixed_high_shocks.csv", ["α", "γ", "ψ", "β_draw", "ρ", "ρ_u", "ρ_v"])
