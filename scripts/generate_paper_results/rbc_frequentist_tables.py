...
# kalman table
kalman_50 = pd.read_csv(".paper_results/freqstats_rbc_1_kalman_50.csv")
...
kalman_100 = pd.read_csv(".paper_results/freqstats_rbc_1_kalman_100.csv").drop(columns = ["Parameter", "num_seeds", "num_samples", "adapts_burnin_prop"])
...
kalman_200 = pd.read_csv(".paper_results/freqstats_rbc_1_kalman_200.csv").drop(columns = ["Parameter", "num_seeds", "num_samples", "adapts_burnin_prop"])
...
# joint 1 table
joint_1_50 = pd.read_csv(".paper_results/freqstats_rbc_1_joint_50.csv")
...
joint_1_100 = pd.read_csv(".paper_results/freqstats_rbc_1_joint_100.csv").drop(columns = ["Parameter", "num_seeds", "num_samples", "adapts_burnin_prop"])
...
joint_1_200 = pd.read_csv(".paper_results/freqstats_rbc_1_joint_200.csv").drop(columns = ["Parameter", "num_seeds", "num_samples", "adapts_burnin_prop"])
...
# joint 2 table
joint_2_50 = pd.read_csv(".paper_results/freqstats_rbc_2_joint_50.csv")
...
joint_2_100 = pd.read_csv(".paper_results/freqstats_rbc_2_joint_100.csv").drop(columns = ["Parameter", "num_seeds", "num_samples", "adapts_burnin_prop"])
...
joint_2_200 = pd.read_csv(".paper_results/freqstats_rbc_2_joint_200.csv").drop(columns = ["Parameter", "num_seeds", "num_samples", "adapts_burnin_prop"])
