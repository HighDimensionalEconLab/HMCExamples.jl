...
estimation(datafile = 'rbc_1.csv', mode_file = 'rbc_mode.mat', order = 1, mh_nblocks = 1, mh_replic = 100000, mh_drop = 0.1, mh_jscale = 0.005, mode_compute = 0, mcmc_jumping_covariance = identity_matrix);
