...
estimation(datafile = '../../data/rbc_2.csv', mode_file = 'rbc_mode.mat', order = 2, mh_nblocks = 1, mh_replic = 10000, mh_drop = 0.1, mode_compute = 0, mcmc_jumping_covariance = identity_matrix, number_of_particles = 2500, mh_jscale = 0.005);
