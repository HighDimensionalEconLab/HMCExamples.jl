...
estimation(datafile = '../../data/rbc_1_200.csv', mode_file = 'rbc_1_robustness_init_params.mat', order = 1, mh_nblocks = 1, mh_replic = 110000, mh_drop = 0.1, mh_jscale = 0.01, mode_compute = 0, mcmc_jumping_covariance = identity_matrix);
