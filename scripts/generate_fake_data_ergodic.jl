...
CSV.write(joinpath(pkgdir(HMCExamples), "data/rbc_1_ergodic.csv"), DataFrame(c_obs = z_vec[1,:], i_obs = z_vec[2,:]))
...
CSV.write(joinpath(pkgdir(HMCExamples), "data/rbc_2_ergodic.csv"), DataFrame(c_obs = z_vec_2[1,:], i_obs = z_vec_2[2,:]))