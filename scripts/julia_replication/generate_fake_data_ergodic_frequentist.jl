...
for T in [50, 100, 200]
    for counter in 1:100
        ...
        CSV.write(joinpath(pkgdir(HMCExamples), string(".data/rbc_1_", counter, "_", T, "_.csv")), DataFrame(c_obs=z_vec[1, :], i_obs=z_vec[2, :]))
        ...
        CSV.write(joinpath(pkgdir(HMCExamples), string(".data/rbc_2_", counter, "_", T, "_.csv")), DataFrame(c_obs=z_vec_2[1, :], i_obs=z_vec_2[2, :]))
    end
end
