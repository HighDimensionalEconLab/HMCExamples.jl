...
for ALPHA in "${ALPHA_VALUES[@]}"; do
  for BETA_DRAW in "${BETA_DRAW_VALUES[@]}"; do
    for RHO in "${RHO_VALUES[@]}"; do
      ...
      run_sampler $BASELINE_SEED $NUM_SAMPLES "fit_rbc_1_kalman.jl" "${RESULTS_PATH}/rbc_1_kalman_robustness_${ALPHA//./_}_${BETA_DRAW//./_}_${RHO//./_}" "" "${DATA_PATH}/rbc_1_kalman_burnin_dynare.csv" "" "--override_init_params [${ALPHA},${BETA_DRAW},${RHO}]"
    done
  done
done
