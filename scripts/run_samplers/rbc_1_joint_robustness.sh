...
for ALPHA in "${ALPHA_VALUES[@]}"; do
  for BETA_DRAW in "${BETA_DRAW_VALUES[@]}"; do
    for RHO in "${RHO_VALUES[@]}"; do
      ...
      run_sampler $BASELINE_SEED $RBC_1_JOINT_SAMPLES "fit_rbc_1_joint.jl" "${RESULTS_PATH}/rbc_1_joint_robustness_${ALPHA//./_}_${BETA_DRAW//./_}_${RHO//./_}" "" "${DATA_PATH}/rbc_1_joint_burnin.csv" "" "--override_init_params [${ALPHA},${BETA_DRAW},${RHO}]"
    done
  done
done
