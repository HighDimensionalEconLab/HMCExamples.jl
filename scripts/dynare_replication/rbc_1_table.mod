...
estimation(datafile = '../../data/rbc_1.csv', mode_file = 'rbc_start.mat', order = 1, mh_nblocks = 1, mh_replic = 175000, mh_drop = 0.1, mh_jscale = 0.01, mode_compute = 0, mcmc_jumping_covariance = identity_matrix);
