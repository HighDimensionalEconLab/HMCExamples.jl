...
dynare_1st_order.insert(0, "Parameters", [r"\alpha", r"100\left(\beta^{-1}-1\right)", r"\rho"])
...
dynare_2nd_order.insert(0, "Parameters", [r"\alpha", r"100\left(\beta^{-1}-1\right)", r"\rho"])
