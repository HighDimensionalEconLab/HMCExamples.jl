...
# kalman table
kalman_50 = pd.read_csv(".results/freqstats_rbc_1_kalman_50.csv")
kalman_50.insert(0, "T", ["T = 50", "", ""])
kalman_100 = pd.read_csv(".results/freqstats_rbc_1_kalman_100.csv")
kalman_100.insert(0, "T", ["T = 100", "", ""])
kalman_200 = pd.read_csv(".results/freqstats_rbc_1_kalman_200.csv")
...
# joint 1 table
joint_1_50 = pd.read_csv(".results/freqstats_rbc_1_joint_50.csv")
joint_1_50.insert(0, "T", ["T = 50", "", ""])
joint_1_100 = pd.read_csv(".results/freqstats_rbc_1_joint_100.csv")
joint_1_100.insert(0, "T", ["T = 100", "", ""])
joint_1_200 = pd.read_csv(".results/freqstats_rbc_1_joint_200.csv")
...
# joint 2 table
joint_2_50 = pd.read_csv(".results/freqstats_rbc_2_joint_50.csv")
joint_2_50.insert(0, "T", ["T = 50", "", ""])
joint_2_100 = pd.read_csv(".results/freqstats_rbc_2_joint_100.csv")
joint_2_100.insert(0, "T", ["T = 100", "", ""])
joint_2_200 = pd.read_csv(".results/freqstats_rbc_2_joint_200.csv")
...
# kalman table
kalman_50 = pd.read_csv(".results/freqstats_rbc_1_kalman_50_drop57.csv")
kalman_50.insert(0, "T", ["T = 50", "", ""])
kalman_100 = pd.read_csv(".results/freqstats_rbc_1_kalman_100_drop57.csv")
kalman_100.insert(0, "T", ["T = 100", "", ""])
kalman_200 = pd.read_csv(".results/freqstats_rbc_1_kalman_200_drop57.csv")
kalman_200.insert(0, "T", ["T = 200", "", ""])
kalman = pd.concat([kalman_50, kalman_100, kalman_200])
kalman_list = kalman.to_latex(index = False, escape = False, column_format = "c" * 6, header = ["", "Parameters", "Mean Bias", "MSE", "Cov. Prob. 80\%", "Cov. Prob. 90\%"], formatters = [lambda s: [s, f"${s}$"][s != ""]] * 2 + [process] * 2 + [pcthandle] * 2).split("\n")
kalman_list.insert(10, r'\midrule')
...
# joint 1 table
joint_1_50 = pd.read_csv(".results/freqstats_rbc_1_joint_50_drop57.csv")
joint_1_50.insert(0, "T", ["T = 50", "", ""])
joint_1_100 = pd.read_csv(".results/freqstats_rbc_1_joint_100_drop57.csv")
joint_1_100.insert(0, "T", ["T = 100", "", ""])
joint_1_200 = pd.read_csv(".results/freqstats_rbc_1_joint_200_drop57.csv")
joint_1_200.insert(0, "T", ["T = 200", "", ""])
joint_1 = pd.concat([joint_1_50, joint_1_100, joint_1_200])
joint_1_list = joint_1.to_latex(index = False, escape = False, column_format = "c" * 6, header = ["", "Parameters", "Mean Bias", "MSE", "Cov. Prob. 80\%", "Cov. Prob. 90\%"], formatters = [lambda s: [s, f"${s}$"][s != ""]] * 2 + [process] * 2 + [pcthandle] * 2).split("\n")
joint_1_list.insert(10, r'\midrule')
...
# joint 2 table
joint_2_50 = pd.read_csv(".results/freqstats_rbc_2_joint_50_drop57.csv")
joint_2_50.insert(0, "T", ["T = 50", "", ""])
joint_2_100 = pd.read_csv(".results/freqstats_rbc_2_joint_100_drop57.csv")
joint_2_100.insert(0, "T", ["T = 100", "", ""])
joint_2_200 = pd.read_csv(".results/freqstats_rbc_2_joint_200_drop57.csv")
joint_2_200.insert(0, "T", ["T = 200", "", ""])
joint_2 = pd.concat([joint_2_50, joint_2_100, joint_2_200])
joint_2_list = joint_2.to_latex(index = False, escape = False, column_format = "c" * 6, header = ["", "Parameters", "Mean Bias", "MSE", "Cov. Prob. 80\%", "Cov. Prob. 90\%"], formatters = [lambda s: [s, f"${s}$"][s != ""]] * 2 + [process] * 2 + [pcthandle] * 2).split("\n")
joint_2_list.insert(10, r'\midrule')
