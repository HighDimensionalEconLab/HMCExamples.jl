...
# Not working yet, so leave out of package compiler builds.
# HMCExamples.main_FVGQ_1_kalman(["--num_samples", "20", "--print_level", "2", "--results_path", "./results/main_FVGQ_1_kalman", "--overwrite_results", "true"])
# HMCExamples.main_FVGQ_1_joint(["--num_samples", "20", "--print_level", "3", "--results_path", "./results/main_FVGQ_1_joint", "--overwrite_results", "true"])
# HMCExamples.main_FVGQ_2_joint(["--num_samples", "10", "--max_depth", "2", "--results_path", "./results/main_FVGQ_2_joint", "--overwrite_results", "true"])
