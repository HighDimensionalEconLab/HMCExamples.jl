...
# HMCExamples.main_sgu_1_kalman(["--num_samples", "30", "--max_depth", "2", "--results_path", "./.results/sgu_1_kalman_test", "--overwrite_results", "true", "--init_params_file", "data/sgu_1_kalman_burnin.csv"])
# HMCExamples.main_sgu_1_joint(["--num_samples", "30", "--max_depth", "2", "--results_path", "./.results/sgu_1_joint_test", "--overwrite_results", "true", "--init_params_file", "data/sgu_1_joint_burnin.csv"])
