...
function H̄!(ˍ₋out, ˍ₋arg1, ˍ₋arg2; )
    let c = @inbounds(ˍ₋arg1[1]), q = @inbounds(ˍ₋arg1[2]), i = @inbounds(ˍ₋arg1[3]), k = @inbounds(ˍ₋arg1[4]), z = @inbounds(ˍ₋arg1[5]), α = @inbounds(ˍ₋arg2[1]), β = @inbounds(ˍ₋arg2[2]), ρ = @inbounds(ˍ₋arg2[3]), δ = @inbounds(ˍ₋arg2[4]), σ = @inbounds(ˍ₋arg2[5]), Ω_1 = @inbounds(ˍ₋arg2[6])
        @inbounds begin
                ˍ₋out[1] = (+)((/)(1, c), (/)((*)(-1, β, (+)(1, (*)(-1, δ), (*)(α, (^)(k, (+)(-1, α)), (exp)(z)))), c))
                ˍ₋out[2] = (+)(c, k, (*)(-1, q), (*)(-1, k, (+)(1, (*)(-1, δ))))
                ˍ₋out[3] = (+)(q, (*)(-1, (^)(k, α), (exp)(z)))
                ˍ₋out[4] = (+)(z, (*)(-1, z, ρ))
                ˍ₋out[5] = (+)(i, (*)(-1, k), (*)(k, (+)(1, (*)(-1, δ))))
                nothing
            end
    end
end
...
function H̄_w!(ˍ₋out, ˍ₋arg1, ˍ₋arg2; )
    let c = @inbounds(ˍ₋arg1[1]), q = @inbounds(ˍ₋arg1[2]), i = @inbounds(ˍ₋arg1[3]), k = @inbounds(ˍ₋arg1[4]), z = @inbounds(ˍ₋arg1[5]), α = @inbounds(ˍ₋arg2[1]), β = @inbounds(ˍ₋arg2[2]), ρ = @inbounds(ˍ₋arg2[3]), δ = @inbounds(ˍ₋arg2[4]), σ = @inbounds(ˍ₋arg2[5]), Ω_1 = @inbounds(ˍ₋arg2[6])
        @inbounds begin
                ...
                ˍ₋out[8] = 1
                ˍ₋out[15] = 1
                ˍ₋out[16] = (/)((*)(-1, α, β, (^)(k, (+)(-2, α)), (+)(-1, α), (exp)(z)), c)
                ˍ₋out[17] = δ
                ˍ₋out[18] = (*)(-1, α, (^)(k, (+)(-1, α)), (exp)(z))
                ˍ₋out[20] = (*)(-1, δ)
                ˍ₋out[21] = (/)((*)(-1, α, β, (^)(k, (+)(-1, α)), (exp)(z)), c)
                ˍ₋out[23] = (*)(-1, (^)(k, α), (exp)(z))
                ˍ₋out[24] = (+)(1, (*)(-1, ρ))
                nothing
            end
    end
...
function ȳ_p!(ˍ₋out, ::Val{:α}, ˍ₋arg2; )
    let α = @inbounds(ˍ₋arg2[1]), β = @inbounds(ˍ₋arg2[2]), ρ = @inbounds(ˍ₋arg2[3]), δ = @inbounds(ˍ₋arg2[4]), σ = @inbounds(ˍ₋arg2[5]), Ω_1 = @inbounds(ˍ₋arg2[6])
        @inbounds begin
                ...
                ˍ₋out[3] = (*)(δ, (+)((/)((*)(-1, (/)((+)(-1, δ, (/)(1, β)), (^)(α, 2)), (^)((/)((+)(-1, δ, (/)(1, β)), α), (+)(-1, (/)(1, (+)(-1, α))))), (+)(-1, α)), (*)(-1, (/)(1, (^)((+)(-1, α), 2)), (^)((/)((+)(-1, δ, (/)(1, β)), α), (/)(1, (+)(-1, α))), (log)((/)((+)(-1, δ, (/)(1, β)), α)))))
                nothing
            end
    end
end
...
function ȳ_p!(ˍ₋out, ::Val{:δ}, ˍ₋arg2; )
    let α = @inbounds(ˍ₋arg2[1]), β = @inbounds(ˍ₋arg2[2]), ρ = @inbounds(ˍ₋arg2[3]), δ = @inbounds(ˍ₋arg2[4]), σ = @inbounds(ˍ₋arg2[5]), Ω_1 = @inbounds(ˍ₋arg2[6])
        @inbounds begin
                ...
                ˍ₋out[3] = (+)((/)((*)(δ, (^)((/)((+)(-1, δ, (/)(1, β)), α), (+)(-1, (/)(1, (+)(-1, α))))), (*)(α, (+)(-1, α))), (^)((/)((+)(-1, δ, (/)(1, β)), α), (/)(1, (+)(-1, α))))
                nothing
            end
    end
end
...
function ȳ_p!(ˍ₋out, ::Val{:β}, ˍ₋arg2; )
    let α = @inbounds(ˍ₋arg2[1]), β = @inbounds(ˍ₋arg2[2]), ρ = @inbounds(ˍ₋arg2[3]), δ = @inbounds(ˍ₋arg2[4]), σ = @inbounds(ˍ₋arg2[5]), Ω_1 = @inbounds(ˍ₋arg2[6])
        @inbounds begin
                ...
                ˍ₋out[3] = (/)((*)(-1, δ, (/)(1, (^)(β, 2)), (^)((/)((+)(-1, δ, (/)(1, β)), α), (+)(-1, (/)(1, (+)(-1, α))))), (*)(α, (+)(-1, α)))
                nothing
            end
    end
end
