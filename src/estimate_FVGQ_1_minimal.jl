# Entry for script
function main_FVGQ_1_minimal(args=ARGS)
    d = parse_commandline_FVGQ_1_minimal(args)
    return estimate_FVGQ_1_minimal((; d...)) # to named tuple
end

function estimate_FVGQ_1_minimal(d)
